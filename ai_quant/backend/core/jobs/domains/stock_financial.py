    ...
    try:
        ...
        for code in codes:
            ...
            for _, r in df2.iterrows():
                ...
                batch.append((code, report_date, revenue, net_profit, eps, roe, roa, gross_margin, net_margin, debt_ratio, current_ratio, operating_cashflow, total_assets, total_equity, "akshare"))
