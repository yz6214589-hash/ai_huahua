...
def _macd(values: list[float], fast: int = 12, slow: int = 26, signal: int = 9) -> tuple[list[float | None], list[float | None], list[float | None]]:
...
def _score_buy(close: float | None, ma20: float | None, boll_lower: float | None, macd_hist: float | None, rsi14: float | None, flags: dict[str, bool]) -> tuple[float, list[str]]:
    score = 50.0
    reasons: list[str] = []
...
def _score_sell(close: float | None, ma20: float | None, boll_upper: float | None, macd_hist: float | None, rsi14: float | None, flags: dict[str, bool]) -> tuple[float, list[str]]:
    score = 50.0
    reasons: list[str] = []
