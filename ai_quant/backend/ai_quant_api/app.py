...
from ai_quant_api.api.conversation_api import router as conversation_router
...
from ai_quant_api.api.logs import router as logs_router
...
from ai_quant_api.api.sentiment import router as sentiment_router
...
from ai_quant_api.api.stock_detail import router as stock_detail_router
from ai_quant_api.config import get_settings, get_logging_settings
from ai_quant_api.runtime.logging_service import init_logging, get_logger, shutdown_logging
...
def create_app() -> FastAPI:
    ...
    def _jobs_scheduler_startup() -> None:
        ...
        try:
            from ai_quant_api.api import jobs as _jobs_api
