...
from src.backend..infra.storage.database import MySQLConfig, connect, executemany, query_dict
...
def _fetch_qmt(code: str, start: str, end: str = "") -> pd.DataFrame | None:
    try:
        from src.backend..infra.qmt_gateway_client import historical_kline
