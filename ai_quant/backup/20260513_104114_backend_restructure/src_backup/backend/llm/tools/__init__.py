...
from src.backend..core.console import trigger_morning
from src.backend..core.data import get_summary
from src.backend..core.execution import create_execution_task
from src.backend..core.risk import approve
...
def run_tool(tool_name: str, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if tool_name == "web_search":
        ...
        script = f"web-search/scripts/search_market.py --query {query} --type {search_type}"
